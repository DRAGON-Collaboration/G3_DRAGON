C     Small Pumping tubes
      SUBROUTINE ugeo_trgt_small_right
      IMPLICIT NONE
      include 'uggeom.inc'
...
C.
      ...
      CALL gspos('ATC2',1,'EX9G',-1.2885-0.7-2.5,0.0,8.93048077,
     +   0,'MANY')
...
C.
      ...
      CALL gspos('ATC4',1,'EX9G',0.0,-0.465-2.5,8.93048077,0,'MANY')
C.
