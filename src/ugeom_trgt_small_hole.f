C     Small Pumping tubes
      SUBROUTINE ugeo_trgt_small_hole
      IMPLICIT NONE
      include 'uggeom.inc'
...
CCC Hole Collimator
      ...
      CALL gsvolu ('ATC0', 'TUBE', 5, shape, 3, ivolu)
      CALL gsatt('ATC0','SEEN',1)
      CALL gspos('ATC0',1,'EX9G',0,0,8.93048077,0,'MANY')
...
c      shape(2) = 2.5
c      shape(3) = 0.025
c      CALL gsvolu ('ATC1', 'BOX ', 5, shape, 3, ivolu)
c      CALL gsatt('ATC1','SEEN',1)
c      CALL gspos('ATC1',1,'EX9G',1.2885+0.7+2.5,0.0,8.93048077,
c     +   0,'MANY') 
C.
C. **** Do -x border
C.
...
c      shape(2) = 2.5
c      shape(3) = 0.025
c      CALL gsvolu ('ATC2', 'BOX ', 5, shape, 3, ivolu)
c      CALL gsatt('ATC2','SEEN',1)
c      CALL gspos('ATC2',1,'EX9G',1.2885-0.7-2.5,0.0,8.93048077,
c    +   0,'MANY')
...
c      shape(2) = 2.5
c      shape(3) = 0.025
c      CALL gsvolu ('ATC3', 'BOX ', 5, shape, 3, ivolu)
c      CALL gsatt('ATC3','SEEN',1)
c      CALL gspos('ATC3',1,'EX9G',0.0,.465+2.5,8.93048077,0,'MANY') 
C.
C. **** Do -y border
C.
C.
...
c      shape(2) = 2.5
c      shape(3) = 0.025
c      CALL gsvolu ('ATC4', 'BOX ', 5, shape, 3, ivolu)
c      CALL gsatt('ATC4','SEEN',1)
c      CALL gspos('ATC4',1,'EX9G',0.0,-0.465-2.5,8.93048077,0,'MANY')
C.
